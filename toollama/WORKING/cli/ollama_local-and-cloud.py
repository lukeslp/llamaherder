...
class OllamaChat:
    ...
    def _fetch_models(self) -> Dict:
        ...
        try:
            ...
            for model in response.json().get("models", []):
                ...
                # Determine context length based on model size
                context_length = 4096  # Default
                if "13b" in model_id or "13B" in model_id:
                    context_length = 8192
    ...
    def encode_image(self, image_path: str) -> Optional[str]:
        ...
        try:
            with Image.open(image_path) as img:
                ...
                # Resize if too large (Ollama typically expects max 2048x2048)
                ...
                img_byte_arr = io.BytesIO()
                save_format = 'JPEG' if img.format == 'JPEG' else 'PNG'
    ...
    def format_message_with_attachments(
        ...
        Returns:
            Union[str, Dict]: Formatted message for the API
        """
...
def main():
    ...
    while True:
        ...
        # Get message
        default_prompt = (
            "What do you see in this image?" if image_data 
            else "Please analyze this file." if file_data 
