...
XAI_API_KEY = os.getenv("XAI_API_KEY") or "xai-JkOIMXNtbfGaTf8iXQUhSPt1LZxwiMbMVWMI4mKQr8wkStYII7BgsYBiQcZ5KZNSn0OPEbxsnM61WkEk"
...
if ALLOWED_ORIGINS_ENV == "*":
    ALLOWED_ORIGINS = ["*", "https://actuallyusefulai.com"]
else:
    ...
    # Also add api.assisted.space
    if "https://api.assisted.space" not in ALLOWED_ORIGINS:
        ALLOWED_ORIGINS.append("https://api.assisted.space")
